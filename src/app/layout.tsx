    ...
    <html lang="en">
      <body>
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
          <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-white/94 backdrop-blur">
            <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-4 lg:flex-row lg:items-center lg:justify-between lg:px-10">
              <div className="flex items-center gap-4">
                <Link href="/" className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-2xl border border-[var(--border)] bg-[#0F2230] shadow-[0_10px_24px_rgba(16,44,60,0.1)]">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs font-semibold uppercase tracking-[0.16em] text-[var(--muted)]">Wide category graph for data center infrastructure</p>
                </div>
              </div>
              <div className="flex flex-col gap-3 lg:items-end">
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/categories" className="rounded-full border border-[var(--border)] bg-white px-4 py-2 text-sm font-semibold text-[var(--foreground)] transition hover:border-[var(--accent)]">
                    Explore categories
                  </Link>
                  <Link href="/vendors" className="rounded-full bg-[var(--accent-strong)] px-4 py-2 text-sm font-semibold text-white shadow-[0_12px_24px_rgba(16,44,60,0.16)] transition hover:-translate-y-0.5">
                    Browse vendors
                  </Link>
                  <Link href="/for-vendors" className="rounded-full border border-[var(--accent)] bg-[#f4f8fb] px-4 py-2 text-sm font-semibold text-[var(--accent-strong)] transition hover:bg-[#e8f1f7]">
                    For vendors
                  </Link>
                </div>
              </div>
            ...
            <div className="mx-auto grid max-w-7xl gap-8 px-6 py-10 lg:grid-cols-[1.2fr_0.8fr] lg:px-10">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="mt-3 text-xs font-semibold uppercase tracking-[0.16em] text-[#8ed1e8]">Broad category coverage  supplier discovery  market-map research</p>
                </div>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <div className="mt-3 grid gap-2 text-sm text-[#d6e2e9]">
                    ...
                    <Link href="/guides" className="transition hover:text-white">Guides and explainers</Link>
                  </div>
                </div>
                <div className="sm:col-span-2 rounded-[1.25rem] border border-white/10 bg-white/5 p-4 text-sm text-[#d6e2e9]">
                  <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#8ed1e8]">Built for supplier discovery</p>
                  <p className="mt-2 leading-7 text-[#b7c9d4]">Use the category graph to survey the full infrastructure stack, move through adjacent systems, compare suppliers, and explore the data center ecosystem as a living resource. Public listings stay moderated so the research surface remains useful.</p>
                </div>
              </div>
            </div>
          </footer>
