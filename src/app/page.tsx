      ...
      <section>
        <div className="mx-auto max-w-6xl px-5 py-14 lg:px-8 lg:py-18">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl">The best place to discover modular data center and infrastructure companies.</h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-[var(--muted-strong)]">
              Browse a focused directory of modular data centers, containerized systems, GPU hosting, cooling, power infrastructure, and related industrial vendors.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-6 lg:px-8 lg:py-8">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white">Start with the infrastructure segment that matters most.</h2>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-5 py-10 lg:px-8 lg:py-12">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold tracking-tight text-white">Credible companies, clean cards, faster scanning.</h2>
          </div>
